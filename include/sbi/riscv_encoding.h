...
#define MSTATUS_VS			(_UL(3) << MSTATUS_VS_SHIFT)
...
#define MSTATUS_SPELP			_UL(0x00800000)	/* Zicfilp: S-mode Previous ELP (bit 23) */
...
#define MSTATUS_MPELP			_ULL(0x0000020000000000)	/* Zicfilp: M-mode Previous ELP (bit 41) */
#else
